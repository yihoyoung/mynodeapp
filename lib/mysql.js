...
let users =
    `create table if not exists users(
     ...
     name VARCHAR(100) CHARACTER SET 'utf8' NOT NULL COMMENT '用户名',
...
let posts =
    `create table if not exists posts(
     id INT NOT NULL AUTO_INCREMENT,
     name VARCHAR(100) CHARACTER SET 'utf8' NOT NULL COMMENT '文章作者',
     title TEXT(0) CHARACTER SET 'utf8' NOT NULL COMMENT '评论题目',
     content TEXT(0) CHARACTER SET 'utf8' NOT NULL COMMENT '评论内容',
     md TEXT(0) CHARACTER SET 'utf8' NOT NULL COMMENT 'markdown',
...
let comment =
    `create table if not exists comment(
     id INT NOT NULL AUTO_INCREMENT,
     name VARCHAR(100) CHARACTER SET 'utf8' NOT NULL COMMENT '用户名称',
     content TEXT(0) CHARACTER SET 'utf8' NOT NULL COMMENT '评论内容',
